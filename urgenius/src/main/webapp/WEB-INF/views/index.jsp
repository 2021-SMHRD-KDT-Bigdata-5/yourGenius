...
-->
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/assets/css/font-awesome.css" />"> 
	<link href="<c:url value="/resources/assets/css/templatemo-softy-pinko.css" />" rel="stylesheet">
